...
$_SESSION['backlink']='Open_study_interest.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container" style='color:black; background:#fff;'> <br>
   ...
   <h2 class='text-center bg-danger' style='color:black'>Student Record (Interest)| www.openstudy.org.in<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
        $sql = "Select * from opne_study_interest order by id DESC";
	  ...
	  ?>
	   <tr>
		...
		<a href="deleteOpenStudyInterest.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td> 		
      </tr>
	  <?php
      $i++;  
