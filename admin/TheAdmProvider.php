...
$page='the_adm_providers';
unset($_SESSION['backlink']);
$_SESSION['backlink']='TheAdmProvider.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>:: Student Record | www.theadmissionprovider.com ::</title>
...
<div class="container" style='color:black; background:#fff;'> 
   <h2 class='text-center bg-danger' style='color:black'>Student Record | www.theadmissionprovider.com<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
		...
		<a href="deleteTheAdmProvider.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>    
      </tr>
          <?php
      $i++;  }
