...
$_SESSION['backlink']='AdmMantraEnquiry.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container" style='color:black; background:#fff;'>
  <div class=' '><br>
   ...
   <h2 class='text-center bg-danger' style='color:black'>Student Enquiry Record | www.admissionmantra.org<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
        $sql = "Select * from mantra_enquiry order by id DESC";
		...
		<a href="deleteAdmMantraEnquiry.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>            
      </tr>
          <?php
      $i++;  }
