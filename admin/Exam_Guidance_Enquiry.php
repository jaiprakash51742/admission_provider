...
$_SESSION['backlink']='Exam_Guidance_Enquiry.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<br> 
   <h2 class='text-center bg-danger' style='color:black'>Student Record (Contact) | www.examguidance.co.in<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
        $sql = "Select * from  exam_guidance_contact order by id DESC";
		...
		<td class='text-center'>
			<a href="deleteExamGuidance.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>    		
      </tr>
          <?php
      $i++;  }
