...
$_SESSION['backlink']='Adm_Bangalore_callback.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div style='color:black; background:#fff; margin-right: 40px;  padding:10px;' class="">
   ...
   <h2 class='text-center bg-danger' style='color:black'>Call Back | www.admissioninbangalore.org<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
        $sql = "Select * from request_call_back order by id DESC";
	  ...
	  ?>
	   <tr  style='color:black;'>
		...
		<a href="deleteAdmBangaloreCallBack.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>         
      </tr>
          <?php
      $i++;  }
