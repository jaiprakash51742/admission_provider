...
$_SESSION['backlink']='displayalldata.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container" style='color:black; background:#fff;'> 
   <h2 class='text-center bg-danger' style='color:black'>Student Record | www.admissionproviders.com<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
		...
		<a href="deleteDisplaydata.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>     
      </tr>
          <?php
      $i++;  }
