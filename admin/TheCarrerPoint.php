<?php 
include_once('config_cp.php');
if(empty($_SESSION['username']))
{
	header("location:../index.php");
}

$page='the_carrer_point';unset($_SESSION['backlink']);
$_SESSION['backlink']='TheCarrerPoint.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>:: Student Record | www.thecareerpoint.org ::</title>
...
<div class="container" style='color:black; background:#fff;'> 
   <h2 class='text-center bg-danger' style='color:black'>Student Record | www.thecareerpoint.org<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
        ...
        <td><?php echo $row['c_course'];  ?></td>  
        <td><?php echo $row['dt'];  ?></td>
		<td class='text-center'>
			<a href="deleteCareerPoint.php?id=<?= $row['id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>       
      </tr>
          <?php
      $i++;  }
