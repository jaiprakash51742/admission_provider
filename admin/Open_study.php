...
$_SESSION['backlink']='Open_study.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container" style='color:black; background:#fff;'> <br>
   ...
   <h2 class='text-center bg-danger' style='color:black'>Student Record (Enquiry)| www.openstudy.org.in<span></h2>
   <div class="table-responsive">
    ...
    <tbody>
      <?php  
        $sql = "Select * from opne_study_enquiry order by Id DESC";
	  ...
	  ?>
	   <tr>
		...
		<a href="deleteOpenStudy.php?id=<?= $row['Id'] ?>" class='bg-danger' style='background:red; color:white; padding:5px 10px; font-weight:bold;'>Delete</a>
		</td>         
      </tr>
	  <?php
      $i++;  
